function updateSearchPlaceholder() {
  ...
  else if (sidebarTab === "text") inp.placeholder = "Search text...";
...
function ensureSelectionFallback() {
  ...
  if (sidebarTab === "text" && texts.length) {
    const hasValidTextSelection = !!(
      currentItem &&
      isTextItem(currentItem) &&
      texts.includes(currentItem)
    );
...
function renderSongs() {
  ...
  displayList.forEach((s, i) => {
    ...
    const isTextUi = sidebarTab === "text" && buttonContextTab === "text";
    if (isScheduleUi) {
...
function selectItem(i, opts = {}) {
  ...
  if (!getIsBibleItem(currentItem) && !isTextItem(currentItem))
